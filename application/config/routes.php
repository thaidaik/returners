...
$route['admin/characters/update/(:any)'] = 'admin_characters/update/$1';
$route['admin/characters/delete/(:any)'] = 'admin_characters/delete/$1';
$route['admin/characters/(:any)'] = 'admin_characters/index/$1'; //$1 = page number
